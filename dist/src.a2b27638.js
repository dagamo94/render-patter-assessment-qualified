...
function render() {
  // *** Render Cart Items ****
  var itemsSection = document.querySelector("#cartItems");
  itemsSection.innerHTML = "";

  if (books.length > 0) {
    var content = books.map(renderBook).join("");
    itemsSection.innerHTML = content;
  } else {
    itemsSection.innerHTML = "Nothing in cart";
  } // *** Render Total ***


  var totalSection = document.querySelector("#cartTotal > .total-price");
  totalSection.innerText = "$".concat(calculateTotal());
}
/*
...
function sortByPriceHelper(bookA, bookB) {
  var priceA = bookA.price;
  var priceB = bookB.price;
  return priceA - priceB;
}

function sortByPrice(event) {
  //event.preventDefault();
  books.sort(sortByPriceHelper);
  render();
}
/*
...
function main() {
  var priceSorter = document.querySelector("#sortBtn");
